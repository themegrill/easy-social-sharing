...
!function t(e, i, a) {
    ...
    1: [function (t, e, i) {
        ...
        function o(t) {
            if (t) {
                var e = /^hsla?\(\s*([+-]?\d+)(?:deg)?\s*,\s*([+-]?[\d\.]+)%\s*,\s*([+-]?[\d\.]+)%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)/,
                    i = t.match(e);
                if (i) {
                    var a = parseFloat(i[4]), o = x(parseInt(i[1]), 0, 360), s = x(parseFloat(i[2]), 0, 100),
                        n = x(parseFloat(i[3]), 0, 100), r = x(isNaN(a) ? 1 : a, 0, 1);
                    return [o, s, n, r]
                }
            }
        }
        ...
        var a = t("color-convert"), o = t("chartjs-color-string"), s = function (t) {
            ...
            if (this.values = {
                ...
                var e = o.getRgba(t);
                if (e) this.setValues("rgb", e); else if (e = o.getHsla(t)) this.setValues("hsl", e); else {
        ...
        s.prototype = {
            ...
            if ("alpha" == t) s = e; else if (e.length) this.values[t] = e.slice(0, t.length), s = e[t.length]; else if (void 0 !== e[t.charAt(0)]) {
        ...
        function a(t) {
            var e, i, a, o = t[0] / 255, s = t[1] / 255, n = t[2] / 255, r = Math.min(o, s, n), h = Math.max(o, s, n),
                l = h - r;
        ...
        function o(t) {
            var e, i, a, o = t[0], s = t[1], n = t[2], r = Math.min(o, s, n), h = Math.max(o, s, n), l = h - r;
        ...
        function s(t) {
            var e = t[0], i = t[1], o = t[2], s = a(t)[0], n = 1 / 255 * Math.min(e, Math.min(i, o)),
                o = 1 - 1 / 255 * Math.max(e, Math.max(i, o));
            return [s, 100 * n, 100 * o]
        }

        function n(t) {
            var e, i, a, o, s = t[0] / 255, n = t[1] / 255, r = t[2] / 255;
        ...
        function l(t) {
            ...
            var o = .4124 * e + .3576 * i + .1805 * a, s = .2126 * e + .7152 * i + .0722 * a,
                n = .0193 * e + .1192 * i + .9505 * a;
            return [100 * o, 100 * s, 100 * n]
        }

        function c(t) {
            var e, i, a, o = l(t), s = o[0], n = o[1], r = o[2];
        ...
        function u(t) {
            var e, i, a, o, s, n = t[0] / 360, r = t[1] / 100, h = t[2] / 100;
        ...
        function f(t) {
            var e, i, a = t[0], o = t[1] / 100, s = t[2] / 100;
        ...
        function v(t) {
            var e = t[0] / 60, i = t[1] / 100, a = t[2] / 100, o = Math.floor(e) % 6, s = e - Math.floor(e),
                n = 255 * a * (1 - i), r = 255 * a * (1 - i * s), h = 255 * a * (1 - i * (1 - s)), a = 255 * a;
            switch (o) {
                case 0:
                    return [a, h, n];
                case 1:
        ...
        function w(t) {
            var e, i, a, o, s = t[0] / 360, n = t[1] / 100, h = t[2] / 100, l = n + h;
        ...
        function I(t) {
            var e, i, a, o = t[0] / 100, s = t[1] / 100, n = t[2] / 100, r = t[3] / 100;
        ...
        function R(t) {
            var e, i, a, o = t[0] / 100, s = t[1] / 100, n = t[2] / 100;
        ...
        for (var s in a) {
            ...
            var n = /(\w+)2(\w+)/.exec(s), r = n[1], h = n[2];
        ...
        "use strict";
        e.exports = function (t) {
            var e = t.helpers, i = {aspectRatio: 1};
        ...
        e.exports = function (t) {
            ...
            t.defaults.bar = {
                ...
                initialize: function (e, i) {
                    ...
                    var s, n = this.getMeta(), r = this.getScaleForId(n.xAxisID), h = this.getScaleForId(n.yAxisID);
                    ...
                    var i = this.getMeta(), a = (this.getScaleForId(i.xAxisID), this.getScaleForId(i.yAxisID)), o = 0;
                    if (a.options.stacked) {
                        var s = this.chart.data.datasets[t].data[e];
                        if (0 > s)for (var n = 0; t > n; n++) {
                            var r = this.chart.data.datasets[n], h = this.chart.getDatasetMeta(n);
                            h.bar && h.yAxisID === a.id && this.chart.isDatasetVisible(n) && (o += r.data[e] < 0 ? r.data[e] : 0)
                        } else for (var l = 0; t > l; l++) {
                            var c = this.chart.data.datasets[l], d = this.chart.getDatasetMeta(l);
                    ...
                    var t = this.getMeta(), e = this.getScaleForId(t.xAxisID),
                        i = (this.getScaleForId(t.yAxisID), this.getBarCount()), a = function () {
                            ...
                            return t
                        }.call(this), o = a * e.options.categoryPercentage, s = (a - a * e.options.categoryPercentage) / 2,
                        n = o / i;
                    if (e.ticks.length !== this.chart.data.labels.length) {
                        var r = e.ticks.length / this.chart.data.labels.length;
                        n *= r
                    }
                    var h = n * e.options.barPercentage, l = n - n * e.options.barPercentage;
                    return {
                        datasetCount: i,
                        tickWidth: a,
                        categoryWidth: o,
                    ...
                    var t = this.getScaleForId(this.getMeta().xAxisID), e = this.getRuler();
                    ...
                    var i = this.getMeta(), a = (this.getScaleForId(i.yAxisID), this.getScaleForId(i.xAxisID)),
                        o = this.getBarIndex(e), s = this.getRuler(),
                    ...
                    var i = this.getMeta(), a = (this.getScaleForId(i.xAxisID), this.getScaleForId(i.yAxisID)),
                        o = this.getDataset().data[t];
                    if (a.options.stacked) {
                        for (var s = 0, n = 0, r = 0; e > r; r++) {
                            var h = this.chart.data.datasets[r], l = this.chart.getDatasetMeta(r);
                    ...
                    var i = this.chart.data.datasets[t._datasetIndex], a = t._index;
                    t._model.backgroundColor = t.custom && t.custom.hoverBackgroundColor ? t.custom.hoverBackgroundColor : e.getValueAtIndexOrDefault(i.hoverBackgroundColor, a, e.getHoverColor(t._model.backgroundColor)),
                ...
                updateElement: function (t, i, a, o) {
                    ...
                    s = r.min < 0 && r.max < 0 ? r.getPixelForValue(r.max) : r.min > 0 && r.max > 0 ? r.getPixelForValue(r.min) : r.getPixelForValue(0), e.extend(t, {
                        ...
                        draw: function () {
                            ...
                            var e = this._chart.ctx, i = this._view, a = i.height / 2, o = i.y - a, s = i.y + a,
                                n = i.base - (i.base - i.x), r = i.borderWidth / 2;
                            ...
                            var h = [[i.base, s], [i.base, o], [n, o], [n, s]], l = ["bottom", "left", "top", "right"],
                    ...
                    var i = this.getMeta(), a = this.getScaleForId(i.xAxisID), o = (this.getScaleForId(i.yAxisID), 0);
                    if (a.options.stacked) {
                        var s = this.chart.data.datasets[t].data[e];
                        if (0 > s)for (var n = 0; t > n; n++) {
                            var r = this.chart.data.datasets[n], h = this.chart.getDatasetMeta(n);
                    ...
                    var t = this.getMeta(), e = (this.getScaleForId(t.xAxisID), this.getScaleForId(t.yAxisID)),
                        i = this.getBarCount(), a = function () {
                    ...
                    var t = this.getScaleForId(this.getMeta().yAxisID), e = this.getRuler();
                    return t.options.stacked ? e.categoryHeight : e.barHeight
                }, calculateBarX: function (t, e) {
                    var i = this.getMeta(), a = this.getScaleForId(i.xAxisID),
                    ...
                    var i = this.getMeta(), a = this.getScaleForId(i.yAxisID),
                        o = (this.getScaleForId(i.xAxisID), this.getBarIndex(e)), s = this.getRuler(),
                        n = a.getPixelForValue(null, t, e, this.chart.isCombo);
        ...
        e.exports = function (t) {
            ...
            t.defaults.bubble = {
                ...
                addElements: function () {
                    ...
                    var i, a = this.getMeta(), o = a.data, s = this.getScaleForId(a.yAxisID);
                    ...
                    var o, s = this.getMeta(), n = this.getScaleForId(s.yAxisID), r = this.getScaleForId(s.xAxisID);
        ...
        e.exports = function (t) {
            ...
            t.defaults.doughnut = {
                ...
                legendCallback: function (t) {
                    var e = [];
                    if (e.push('<ul class="' + t.id + '-legend">'), t.data.datasets.length)for (var i = 0; i < t.data.datasets[0].data.length; ++i)e.push('<li><span style="background-color:' + t.data.datasets[0].backgroundColor[i] + '"></span>'), t.data.labels[i] && e.push(t.data.labels[i]), e.push("</li>");
                    ...
                    labels: {
                        generateLabels: function (t) {
                            ...
                            return i.labels.length && i.datasets.length ? i.labels.map(function (a, o) {
                                var s = t.getDatasetMeta(0), n = i.datasets[0], r = s.data[o],
                        ...
                        var i, a, o, s = e.index, n = this.chart;
                ...
                linkScales: function () {
                    ...
                    var o = new t.elements.Arc({_chart: this.chart.chart, _datasetIndex: this.index, _index: i});
                    ...
                    if (this.chart.options.circumference < 2 * Math.PI) {
                        ...
                        var r = n + this.chart.options.circumference, h = {x: Math.cos(n), y: Math.sin(n)},
                            ...
                            f = this.chart.options.cutoutPercentage / 100, p = {
                    ...
                    var o = (this.chart.chartArea.left + this.chart.chartArea.right) / 2,
                        ...
                        n = this.chart.options.rotation, r = this.chart.options.rotation,
        ...
        e.exports = function (t) {
            ...
            t.defaults.line = {
                ...
                addElements: function () {
                    ...
                    var i, a = this.getMeta(), o = a.dataset, s = a.data, n = this.getScaleForId(a.yAxisID);
                    this.getScaleForId(a.xAxisID);
                    ...
                    var a = this.chart.options.elements.point.borderColor, o = this.getDataset();
                    ...
                    var a = this.chart.options.elements.point.borderWidth, o = this.getDataset();
                    ...
                    var o = this.getMeta(), s = (this.getScaleForId(o.xAxisID), this.getScaleForId(o.yAxisID));
                    if (s.options.stacked) {
                        for (var n = 0, r = 0, h = 0; i > h; h++) {
                            var l = this.chart.data.datasets[h], c = this.chart.getDatasetMeta(h);
            ...
            t.defaults.polarArea = {
                ...
                linkScales: function () {
                    ...
                    var c = t.hidden ? 0 : this.chart.scale.getDistanceFromCenterForValue(this.getDataset().data[i]),
                        d = -.5 * Math.PI + o * r, u = d + (t.hidden ? 0 : o), g = {
                            x: s,
                            y: n,
                            innerRadius: 0,
        ...
        e.exports = function (t) {
            ...
            t.defaults.radar = {
                ...
                linkScales: function () {
                    ...
                    var i, a = this.getMeta(), o = a.dataset, s = a.data, n = this.chart.scale;
            ...
            t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function (i) {
                ...
                initialize: function () {
                    ...
                    if (this.scales = {}, this.options.scales && (this.options.scales.xAxes && this.options.scales.xAxes.length && e.each(this.options.scales.xAxes, function (i, a) {
                            var o = e.getValueOrDefault(i.type, "category"), s = t.scaleService.getScaleConstructor(o);
                            if (s) {
                                var n = new s({ctx: this.chart.ctx, options: i, chart: this, id: i.id});
                                this.scales[n.id] = n
                            }
                        }, this), this.options.scales.yAxes && this.options.scales.yAxes.length && e.each(this.options.scales.yAxes, function (i, a) {
                            var o = e.getValueOrDefault(i.type, "linear"), s = t.scaleService.getScaleConstructor(o);
                            if (s) {
                                var n = new s({ctx: this.chart.ctx, options: i, chart: this, id: i.id});
                                this.scales[n.id] = n
                            }
                        ...
                        if (i) {
                            var a = new i({ctx: this.chart.ctx, options: this.options.scale, chart: this});
                    ...
                    if (t.pluginService.notifyPlugins("beforeRender", [this]), this.options.animation && ("undefined" != typeof i && 0 !== i || "undefined" == typeof i && 0 !== this.options.animation.duration)) {
                        ...
                        o.numSteps = (i || this.options.animation.duration) / 16.66, o.easing = this.options.animation.easing, o.render = function (t, i) {
                            var a = e.easingEffects[i.easing], o = i.currentStep / i.numSteps, s = a(o);
        ...
        e.exports = function (t) {
            ...
            t.DatasetController = function (t, e) {
                ...
                }, addElements: i, addElementAndReset: i, draw: i, removeHoverStyle: i, setHoverStyle: i, update: i
            ...
            t.elements = {}, t.Element = function (t) {
                ...
                initialize: function () {
                    ...
                    return this._view || (this._view = e.clone(this._model)), 1 === t ? (this._view = this._model, this._start = null, this) : (this._start || this.pivot(), e.each(this._model, function (i, a) {
                        if ("_" !== a[0] && this._model.hasOwnProperty(a))if (this._view.hasOwnProperty(a))if (i === this._view[a]); else if ("string" == typeof i)try {
                        ...
                        } else this._view[a] = i; else"number" != typeof i || isNaN(this._view[a]) ? this._view[a] = i : this._view[a] = i * t; else;
                    }, this), this)
        ...
        e.exports = function (t) {
            ...
            function i(t, i, a) {
                var o, s = document.defaultView.getComputedStyle(t)[i],
                    n = document.defaultView.getComputedStyle(t.parentNode)[i], r = null !== s && "none" !== s,
                    h = null !== n && "none" !== n;
            ...
            o.each = function (t, e, i, a) {
                var s, n;
                if (o.isArray(t))if (n = t.length, a)for (s = n - 1; s >= 0; s--)e.call(i, t[s], s); else for (s = 0; n > s; s++)e.call(i, t[s], s); else if ("object" == typeof t) {
                    var r = Object.keys(t);
                ...
                return o.each(Array.prototype.slice.call(arguments, 1), function (e) {
                    o.each(e, function (a, s) {
                        if (e.hasOwnProperty(s))if ("scales" === s) i[s] = o.scaleMerge(i.hasOwnProperty(s) ? i[s] : {}, a); else if ("scale" === s) i[s] = o.configMerge(i.hasOwnProperty(s) ? i[s] : {}, t.scaleService.getScaleDefaults(a.type), a); else if (i.hasOwnProperty(s) && o.isArray(i[s]) && o.isArray(a)) {
                            var n = i[s];
                ...
                var i = e.x - t.x, a = e.y - t.y, o = Math.sqrt(i * i + a * a), s = Math.atan2(a, i);
                return s < -.5 * Math.PI && (s += 2 * Math.PI), {angle: s, distance: o}
            }, o.aliasPixel = function (t) {
                return t % 2 === 0 ? 0 : .5
            }, o.splineCurve = function (t, e, i, a) {
                var o = t.skip ? e : t, s = e, n = i.skip ? e : i,
                    r = Math.sqrt(Math.pow(s.x - o.x, 2) + Math.pow(s.y - o.y, 2)),
                    h = Math.sqrt(Math.pow(n.x - s.x, 2) + Math.pow(n.y - s.y, 2)), l = r / (r + h), c = h / (r + h);
                l = isNaN(l) ? 0 : l, c = isNaN(c) ? 0 : c;
                var d = a * l, u = a * c;
                return {
                    previous: {x: s.x - d * (n.x - o.x), y: s.y - d * (n.y - o.y)},
                ...
                var i, a = Math.floor(o.log10(t)), s = t / Math.pow(10, a);
            ...
            o.requestAnimFrame = function () {
                ...
                var i, a, s = t.originalEvent || t, n = t.currentTarget || t.srcElement, r = n.getBoundingClientRect();
                s.touches && s.touches.length > 0 ? (i = s.touches[0].clientX, a = s.touches[0].clientY) : (i = s.clientX, a = s.clientY);
                var h = parseFloat(o.getStyle(n, "padding-left")), l = parseFloat(o.getStyle(n, "padding-top")),
                    c = parseFloat(o.getStyle(n, "padding-right")), d = parseFloat(o.getStyle(n, "padding-bottom")),
                    u = r.right - r.left - h - c, g = r.bottom - r.top - l - d;
                ...
                o.each(i, function (e) {
                    if (void 0 !== e && null !== e) {
                        var i = a.data[e];
                        i || (i = a.data[e] = t.measureText(e).width, a.garbageCollect.push(e)),
                        i > s && (s = i)
                    }
                });
        ...
        e.exports = function (t) {
            ...
            t.layoutService = {
                defaults: {}, addBox: function (t, e) {
                    ...
                    if (t) {
                        var h = 0, l = 0, c = e.where(t.boxes, function (t) {
                        ...
                        var p = i - 2 * h, m = a - 2 * l, b = p / 2, x = m / 2, v = (i - b) / (c.length + d.length),
                            y = (a - x) / (u.length + g.length), k = p, S = m, C = [];
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.legend = {
                ...
                initialize: function (t) {
                    ...
                    var i = this.options, a = i.labels, o = i.display, s = this.ctx, n = t.defaults.global,
                        r = e.getValueOrDefault, h = r(a.fontSize, n.defaultFontSize),
                        l = r(a.fontStyle, n.defaultFontStyle), c = r(a.fontFamily, n.defaultFontFamily),
                        d = e.fontString(h, l, c), u = this.legendHitBoxes = [], g = this.minSize,
                        f = this.isHorizontal();
                    if (f ? (g.width = this.maxWidth, g.height = o ? 10 : 0) : (g.width = o ? 10 : 0, g.height = this.maxHeight), o && f) {
                        var p = this.lineWidths = [0], m = this.legendItems.length ? h + a.padding : 0;
                    ...
                    var i = this.options, a = i.labels, o = t.defaults.global, s = o.elements.line, n = this.width,
                        r = this.lineWidths;
                    if (i.display) {
                        var h = this.ctx, l = {x: this.left + (n - r[0]) / 2, y: this.top + a.padding, line: 0},
                            c = e.getValueOrDefault, d = c(a.fontColor, o.defaultFontColor),
                            u = c(a.fontSize, o.defaultFontSize), g = c(a.fontStyle, o.defaultFontStyle),
                            f = c(a.fontFamily, o.defaultFontFamily), p = e.fontString(u, g, f);
                        if (this.isHorizontal()) {
                            ...
                            e.each(this.legendItems, function (t, e) {
                                var i = h.measureText(t.text).width, d = m + u / 2 + i, g = l.x, f = l.y;
                    ...
                    var i = e.getRelativePosition(t, this.chart.chart), a = i.x, o = i.y, s = this.options;
                    if (a >= this.left && a <= this.right && o >= this.top && o <= this.bottom)for (var n = this.legendHitBoxes, r = 0; r < n.length; ++r) {
                        var h = n[r];
        ...
        e.exports = function (t) {
            ...
            t.defaults.scale = {
                ...
                fit: function () {
                    var i = this.minSize = {width: 0, height: 0}, a = this.options, o = a.ticks, s = a.scaleLabel,
                        n = t.defaults.global, r = a.display, h = this.isHorizontal(),
                        l = e.getValueOrDefault(o.fontSize, n.defaultFontSize),
                        c = e.getValueOrDefault(o.fontStyle, n.defaultFontStyle),
                        d = e.getValueOrDefault(o.fontFamily, n.defaultFontFamily), u = e.fontString(l, c, d),
                    ...
                    if (h ? i.width = this.isFullWidth() ? this.maxWidth - this.margins.left - this.margins.right : this.maxWidth : i.width = r ? m : 0, h ? i.height = r ? m : 0 : i.height = this.maxHeight, s.display && r && (h ? i.height += 1.5 * g : i.width += 1.5 * g), o.display && r) {
                        ...
                        if (h) {
                            ...
                            var C = this.maxWidth - i.width, w = o.mirror;
                ...
                draw: function (i) {
                    if (this.options.display) {
                        var a, o, s, n, r, h = 0 !== this.labelRotation, l = this.options.ticks.autoSkip;
                        ...
                        var c = e.getValueOrDefault(this.options.ticks.fontColor, t.defaults.global.defaultFontColor),
                            ...
                            f = e.fontString(d, u, g), p = this.options.gridLines.tickMarkLength,
                            ...
                            y = e.fontString(b, x, v), k = Math.cos(e.toRadians(this.labelRotation)),
                        ...
                        if (this.ctx.fillStyle = c, this.isHorizontal()) {
                            ...
                            if (o = !1, (S / 2 + this.options.ticks.autoSkipPadding) * this.ticks.length > this.width - (this.paddingLeft + this.paddingRight) && (o = 1 + Math.floor((S / 2 + this.options.ticks.autoSkipPadding) * this.ticks.length / (this.width - (this.paddingLeft + this.paddingRight)))), r && this.ticks.length > r)for (; !o || this.ticks.length / (o || 1) > r;)o || (o = 1), o += 1;
                            ...
                            if (e.each(this.ticks, function (t, o) {
                                    if (void 0 !== t && null !== t) {
                                        ...
                                        if (this.options.gridLines.display && (o === ("undefined" != typeof this.zeroLineIndex ? this.zeroLineIndex : 0) ? (this.ctx.lineWidth = this.options.gridLines.zeroLineWidth, this.ctx.strokeStyle = this.options.gridLines.zeroLineColor, a = !0) : a && (this.ctx.lineWidth = this.options.gridLines.lineWidth, this.ctx.strokeStyle = this.options.gridLines.color, a = !1), s += e.aliasPixel(this.ctx.lineWidth), this.ctx.beginPath(), this.options.gridLines.drawTicks && (this.ctx.moveTo(D, s), this.ctx.lineTo(M, s)), this.options.gridLines.drawOnChartArea && (this.ctx.moveTo(i.left, s), this.ctx.lineTo(i.right, s)), this.ctx.stroke()), this.options.ticks.display) {
                                            ...
                                            this.ctx.save(), "left" === this.options.position ? this.options.ticks.mirror ? (n = this.right + this.options.ticks.padding, this.ctx.textAlign = "left") : (n = this.right - this.options.ticks.padding, this.ctx.textAlign = "right") : this.options.ticks.mirror ? (n = this.left - this.options.ticks.padding, this.ctx.textAlign = "right") : (n = this.left + this.options.ticks.padding, this.ctx.textAlign = "left"), this.ctx.translate(n, r + this.options.ticks.labelOffset), this.ctx.rotate(-1 * e.toRadians(this.labelRotation)), this.ctx.font = f, this.ctx.textBaseline = "middle", this.ctx.fillText(t, 0, 0), this.ctx.restore()
                                        }
                                    }
                        ...
                        var A = this.left, I = this.right, F = this.top, P = this.bottom;
        ...
        e.exports = function (t) {
            ...
            t.Title = t.Element.extend({
                ...
                beforeFit: i,
                fit: function () {
                    var i = (this.ctx, e.getValueOrDefault), a = this.options, o = t.defaults.global, s = a.display,
                        n = i(a.fontSize, o.defaultFontSize), r = this.minSize;
                ...
                draw: function () {
                    var i = this.ctx, a = e.getValueOrDefault, o = this.options, s = t.defaults.global;
                    if (o.display) {
                        var n, r, h = a(o.fontSize, s.defaultFontSize), l = a(o.fontStyle, s.defaultFontStyle),
                            c = a(o.fontFamily, s.defaultFontFamily), d = e.fontString(h, l, c), u = 0;
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.tooltips = {
                ...
                initialize: function () {
                    ...
                    return {x: Math.round(o / e.length), y: Math.round(s / e.length)}
                }, update: function (t) {
                    if (this._active.length) {
                        this._model.opacity = 1;
                        var e, a = this._active[0], o = [], s = [];
                    ...
                    var s, n, r, h, l, c, d = this._view, u = this._chart.ctx;
                    ...
                    if (0 !== e.opacity) {
                        var a = e.caretPadding, o = this.getTooltipSize(e), s = {x: e.x, y: e.y},
            ...
            a.elements.arc = {
                ...
                inLabelRange: function (t) {
                    ...
                    if (a) {
                        ...
                        for (; s > h;)s -= 2 * Math.PI;
                        for (; r > s;)s += 2 * Math.PI;
                        var l = s >= r && h >= s, c = n >= a.innerRadius && n <= a.outerRadius;
                        return l && c
                    }
                    return !1
                }, tooltipPosition: function () {
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.elements.line = {
                ...
                lineToNextPoint: function (t, e, i, a, o) {
                    ...
                    var a = this, o = this._view, s = this._chart.ctx, n = this._children[0],
                    ...
                    s.save(), this._children.length > 0 && o.fill && (s.beginPath(), e.each(this._children, function (t, i) {
                        var a = e.previousItem(this._children, i), n = e.nextItem(this._children, i);
        ...
        e.exports = function (t) {
            ...
            i.elements.point = {
                ...
                inRange: function (t, e) {
                    ...
                    var i = this._view, a = i.x, o = i.y, s = this._chart.ctx;
                    if (!i.skip) {
                        var n = i.pointStyle;
                        ...
                        if (!isNaN(i.radius) && i.radius > 0) {
                            ...
                            switch (n) {
                                default:
                                    s.beginPath(), s.arc(a, o, l, 0, 2 * Math.PI), s.closePath(), s.fill();
                                    break;
                                case"triangle":
                                    s.beginPath();
                                    var c = 3 * l / Math.sqrt(3), d = c * Math.sqrt(3) / 2;
                                    s.moveTo(a - c / 2, o + d / 3), s.lineTo(a + c / 2, o + d / 3), s.lineTo(a, o - 2 * d / 3), s.closePath(), s.fill();
                                    break;
                                case"rect":
                                    s.fillRect(a - 1 / Math.SQRT2 * l, o - 1 / Math.SQRT2 * l, 2 / Math.SQRT2 * l, 2 / Math.SQRT2 * l), s.strokeRect(a - 1 / Math.SQRT2 * l, o - 1 / Math.SQRT2 * l, 2 / Math.SQRT2 * l, 2 / Math.SQRT2 * l);
                                    break;
                                case"rectRot":
                                    s.translate(a, o), s.rotate(Math.PI / 4), s.fillRect(-1 / Math.SQRT2 * l, -1 / Math.SQRT2 * l, 2 / Math.SQRT2 * l, 2 / Math.SQRT2 * l), s.strokeRect(-1 / Math.SQRT2 * l, -1 / Math.SQRT2 * l, 2 / Math.SQRT2 * l, 2 / Math.SQRT2 * l), s.setTransform(1, 0, 0, 1, 0, 0);
                                    break;
                                case"cross":
                                    s.beginPath(), s.moveTo(a, o + l), s.lineTo(a, o - l), s.moveTo(a - l, o), s.lineTo(a + l, o), s.closePath();
                                    break;
                                case"crossRot":
                                    s.beginPath(), r = Math.cos(Math.PI / 4) * l, h = Math.sin(Math.PI / 4) * l, s.moveTo(a - r, o - h), s.lineTo(a + r, o + h), s.moveTo(a - r, o + h), s.lineTo(a + r, o - h), s.closePath();
                                    break;
                                case"star":
                                    s.beginPath(), s.moveTo(a, o + l), s.lineTo(a, o - l), s.moveTo(a - l, o), s.lineTo(a + l, o), r = Math.cos(Math.PI / 4) * l, h = Math.sin(Math.PI / 4) * l, s.moveTo(a - r, o - h), s.lineTo(a + r, o + h), s.moveTo(a - r, o + h), s.lineTo(a + r, o - h), s.closePath();
                                    break;
                                case"line":
                                    s.beginPath(), s.moveTo(a - l, o), s.lineTo(a + l, o), s.closePath();
                                    break;
                                case"dash":
        ...
        e.exports = function (t) {
            ...
            e.elements.rectangle = {
                ...
                draw: function () {
                    ...
                    var e = this._chart.ctx, i = this._view, a = i.width / 2, o = i.x - a, s = i.x + a,
                        n = i.base - (i.base - i.y), r = i.borderWidth / 2;
                    i.borderWidth && (o += r, s -= r, n += r), e.beginPath(), e.fillStyle = i.backgroundColor, e.strokeStyle = i.borderColor, e.lineWidth = i.borderWidth;
                    var h = [[o, i.base], [o, n], [s, n], [s, i.base]], l = ["bottom", "left", "top", "right"],
                        c = l.indexOf(i.borderSkipped, 0);
                    -1 === c && (c = 0), e.moveTo.apply(e, t(0));
                    for (var d = 1; 4 > d; d++)e.lineTo.apply(e, t(d));
                    e.fill(), i.borderWidth && e.stroke()
        ...
        e.exports = function (t) {
            var e = t.helpers, i = {position: "bottom"}, a = t.Scale.extend({
                determineDataLimits: function () {
                    ...
                    if (this.isHorizontal()) {
                        var s = this.width - (this.paddingLeft + this.paddingRight), n = s / o,
                            r = n * (e - this.minIndex) + this.paddingLeft;
                        return this.options.gridLines.offsetGridLines && a && (r += n / 2), this.left + Math.round(r)
                    }
                    var h = this.height - (this.paddingTop + this.paddingBottom), l = h / o,
                ...
                determineDataLimits: function () {
                    if (this.min = null, this.max = null, this.options.stacked) {
                        ...
                        e.each(this.chart.data.datasets, function (o, s) {
                            ...
                            var r = t[n.type].positiveValues, h = t[n.type].negativeValues;
                    ...
                    if (this.options.ticks.beginAtZero) {
                        var o = e.sign(this.min), s = e.sign(this.max);
                    ...
                    i = Math.max(2, i);
                    var o,
                        s = this.options.ticks.fixedStepSize && this.options.ticks.fixedStepSize > 0 || this.options.ticks.stepSize && this.options.ticks.stepSize > 0;
                    if (s) o = e.getValueOrDefault(this.options.ticks.fixedStepSize, this.options.ticks.stepSize); else {
                        var n = e.niceNum(this.max - this.min, !1);
                        o = e.niceNum(n / (i - 1), !0)
                    }
                    var r = Math.floor(this.min / o) * o, h = Math.ceil(this.max / o) * o, l = (h - r) / o;
                    ...
                    var o, s = +this.getRightValue(t), n = this.end - this.start;
                    if (this.isHorizontal()) {
            ...
            var e = t.helpers, i = {
                ...
                determineDataLimits: function () {
                    if (this.min = null, this.max = null, this.options.stacked) {
                        ...
                        e.each(this.chart.data.datasets, function (i, a) {
                            ...
                            this.chart.isDatasetVisible(a) && (this.isHorizontal() ? o.xAxisID === this.id : o.yAxisID === this.id) && (void 0 === t[o.type] && (t[o.type] = []), e.each(i.data, function (e, i) {
                                var a = t[o.type], s = +this.getRightValue(e);
                    ...
                    for (var t = void 0 !== this.options.ticks.min ? this.options.ticks.min : Math.pow(10, Math.floor(e.log10(this.min))); t < this.max;) {
                        this.ticks.push(t);
                        var i = Math.floor(e.log10(t)), a = Math.floor(t / Math.pow(10, i)) + 1;
                    ...
                    var s, n = +this.getRightValue(t), r = e.log10(this.end) - e.log10(this.start);
                    if (this.isHorizontal())if (0 === n) s = this.left + this.paddingLeft; else {
                        var h = this.width - (this.paddingLeft + this.paddingRight);
                        s = this.left + h / r * (e.log10(n) - e.log10(this.start)), s += this.paddingLeft
                    } else if (0 === n) s = this.top + this.paddingTop; else {
        ...
        e.exports = function (t) {
            var e = t.helpers, i = {
                ...
                getValueCount: function () {
                    ...
                    a = Math.max(2, a);
                    var o = e.niceNum(this.max - this.min, !1), s = e.niceNum(o / (a - 1), !0),
                        n = Math.floor(this.min / s) * s, r = Math.ceil(this.max / s) * s, h = Math.ceil((r - n) / s);
                    ...
                    var i, a, o, s, n, r, h, l, c, d, u, g,
                        f = e.getValueOrDefault(this.options.pointLabels.fontSize, t.defaults.global.defaultFontSize),
                        ...
                        b = e.fontString(f, p, m), x = e.min([this.height / 2 - f - 5, this.width / 2]), v = this.width,
                        y = 0;
                    ...
                    if (this.options.display) {
                        ...
                        if (e.each(this.ticks, function (a, o) {
                                if (o > 0 || this.options.reverse) {
                                    var s = this.getDistanceFromCenterForValue(this.ticks[o]), n = this.yCenter - s;
                                    if (this.options.gridLines.display)if (i.strokeStyle = this.options.gridLines.color, i.lineWidth = this.options.gridLines.lineWidth, this.options.lineArc) i.beginPath(), i.arc(this.xCenter, this.yCenter, s, 0, 2 * Math.PI), i.closePath(), i.stroke(); else {
                                        i.beginPath();
                            ...
                            for (var a = this.getValueCount() - 1; a >= 0; a--) {
                                ...
                                var d = this.pointLabels.length, u = this.pointLabels.length / 2, g = u / 2,
                                    f = g > a || a > d - g, p = a === g || a === d - g;
            ...
            var e = t.helpers, i = {
                ...
                initialize: function () {
                    ...
                    this.chart.data.labels && this.chart.data.labels.length > 0 ? (e.each(this.chart.data.labels, function (e, i) {
                        ...
                        var s = [], n = this.chart.isDatasetVisible(o);
                    ...
                    if (this.ctx.font = r, this.ticks = [], this.unitScale = 1, this.scaleSizeInUnits = 0, this.options.time.unit) this.tickUnit = this.options.time.unit || "day", this.displayFormat = this.options.time.displayFormats[this.tickUnit], this.scaleSizeInUnits = this.lastTick.diff(this.firstTick, this.tickUnit, !0), this.unitScale = e.getValueOrDefault(this.options.time.unitStepSize, 1); else {
                        var h = this.isHorizontal() ? this.width - (this.paddingLeft + this.paddingRight) : this.height - (this.paddingTop + this.paddingBottom),
                            l = this.tickFormatFunction(this.firstTick, 0, []), c = this.ctx.measureText(l).width,
                        ...
                        for (var f = 0, p = i.units[f]; f < i.units.length;) {
                            if (this.unitScale = 1, e.isArray(p.steps) && Math.ceil(this.scaleSizeInUnits / g) < e.max(p.steps)) {
                                for (var m = 0; m < p.steps.length; ++m)if (p.steps[m] >= Math.ceil(this.scaleSizeInUnits / g)) {
                            ...
                            var b = this.firstTick.diff(this.getMomentStartOf(this.firstTick), this.tickUnit, !0),
                                x = this.getMomentStartOf(this.lastTick.clone().add(1, this.tickUnit)).diff(this.lastTick, this.tickUnit, !0);
                    ...
                    var v;
                    if (this.options.time.min ? v = this.getMomentStartOf(this.firstTick) : (this.firstTick = this.getMomentStartOf(this.firstTick), v = this.firstTick), !this.options.time.max) {
                    ...
                    var o = t.format(this.displayFormat), s = this.options.ticks,
                        n = e.getValueOrDefault(s.callback, s.userCallback);
                    return n ? n(o, i, a) : o
                }, convertTicksToLabels: function () {
                    ...
                    if (o) {
                        var s = o.diff(this.firstTick, this.tickUnit, !0), n = s / this.scaleSizeInUnits;
                        if (this.isHorizontal()) {
                            var r = this.width - (this.paddingLeft + this.paddingRight),
