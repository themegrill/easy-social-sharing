...
jQuery(document).ready(function ($) {
    ...
    function setAvailableNetworks(response) {
        $.each($('.ess-popup-share-wrapper').find('ul.ess-available-networks').find('li'), function (list_key, list_obj) {

            var network_name = $(this).find('a').attr('data-social-name');

            if (typeof response[network_name] != "undefined") {

                $(this).find('.ess-social-count').html(formatNumber(response[network_name]));
    ...
    function setChoosenNetwork(response) {
        ...
        $.each($('.ess-popup-block-wrapper').find('ul.ess-choosen-networks').find('li'), function (list_key, list_obj) {
    ...
    function setFlyInNetwork(response) {
        ...
        $.each($('.ess-fly-share-wrapper').find('ul.ess-clear').find('li'), function (list_key, list_obj) {
    ...
    function setInlineNetwork(response) {
        ...
        $.each($('#ess-wrap-inline-networks').find('ul.ess-social-network-lists').find('li'), function (list_key, list_obj) {
    ...
    function setSidebarNetwork(response) {
        ...
        $.each($('.ess-sidebar-icon-count-wrapper').find('ul.ess-social-network-lists').find('li'), function (list_key, list_obj) {

            var network_name = $(this).find('a').attr('data-social-name');

            if (typeof response[network_name] != "undefined") {

                total_share += parseInt(response[network_name]);
...
(function ($) {
    ...
    $.fn.textTooltip = function (options) {
        ...
        return this.each(function () {
            ...
            var toolTip = {
                ...
                getToolTipPositionTop: function (e, selection) {

                    return e.pageY;

                }, getToolTipPositionLeft: function (e, selection) {

                    return e.pageX;
                }, getToolTipMinHeight: function (e, selection) {

                    return "400";

                }, getToolTipMinWidth: function (e, selection) {

                    return "400";
                }, getToolTipArrowPosition: function (e, selection) {
  ...
  /*  $('body').textTooltip({
        ...
        data: "<h1>Hello world this is tooltip data</h1>"
    });*/
