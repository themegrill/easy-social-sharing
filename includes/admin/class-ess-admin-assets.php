...
class ESS_Admin_Assets {
	...
	public function admin_scripts() {
		...
		// Register Scripts
		wp_register_script( 'easy-social-sharing-admin', ESS()->plugin_url() . '/assets/js/admin/admin' . $suffix . '.js', array( 'jquery', 'jquery-ui-sortable', 'jquery-ui-widget', 'jquery-ui-core', 'jquery-tiptip' ), ESS_VERSION );
